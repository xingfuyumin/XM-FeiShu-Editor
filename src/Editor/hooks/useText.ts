...
import { BulletElement, CalloutElement, HeadingElement, OrderedElement, TextElement } from '../index.d';
export default (element: BulletElement | OrderedElement | TextElement | HeadingElement | CalloutElement) => {
